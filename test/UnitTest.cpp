...
TEST(NewUnitTests, LevelUpFunction) {
	...
	ASSERT_TRUE(Unit1.Player::getName() == "MaceWindu");
	ASSERT_TRUE(Unit1.Player::getHp() == 319);
	ASSERT_TRUE(Unit1.Player::getDmg() == 110);
	ASSERT_TRUE(Unit1.Player::getAttackspeed() == 5.76);
}
